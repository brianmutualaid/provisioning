...
usage() {
  ...
  -d: Domain for the website that will be hosted on the new server. Don't include a subdomain.
  -e: Email address to use for LetsEncrypt certificate. No default.
...
../scripts/web/01.sh "$domain" "$files" "$email"
